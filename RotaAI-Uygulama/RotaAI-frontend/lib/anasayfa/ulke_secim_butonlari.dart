...
import 'package:ornek003/kktc/kktc_sayfasi.dart';
import 'package:ornek003/turkiye/turkiye_sayfasi.dart' as furkan;
        ...
        Expanded(
          child: _buildCountryCard(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => const KKTCSayfasi()),
              );
            },
          ),
        ),
