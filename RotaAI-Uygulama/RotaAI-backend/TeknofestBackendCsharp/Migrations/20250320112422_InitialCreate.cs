        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlaceImage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    PlaceDesc = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VisitedPlaces", x => new { x.UserId, x.PlaceId });
                    table.ForeignKey(
